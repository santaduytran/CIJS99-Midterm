...
const MovieStore = () => {
  const [movies, setMovies] = useState(listMovieData);
  const [selectedMovie, setSelectedMovie] = useState({});

  function handleSelectedMovie(productId) {
    const movie = movies.find((item) => item.id === productId);
